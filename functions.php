...
function gl_scripts() {
  wp_enqueue_style( 'gl-style', get_template_directory_uri() . '/assets/css/style.css' );
  wp_enqueue_style( 'gl-g-fonts', 'https://fonts.googleapis.com/css?family=Fira+Mono|Fira+Sans:400,700' );

  wp_enqueue_script( 'gl-fontfaceobserver', get_template_directory_uri() . '/assets/js/lib/fontfaceobserver.js', array(), '20161026', false );

  wp_enqueue_script( 'gl-navigation', get_template_directory_uri() . '/assets/js/dist/scripts.min.js', array(), '20161027', true );
